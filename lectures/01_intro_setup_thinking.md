...
Introduce the tutor and explain the rules now, because you will not be in the
room when they hit them — students who are not warned that the tutor refuses to
hand over code get frustrated and rate it badly.

**Live link** (also on Brightspace, which is where you should send them —
nobody types this):
